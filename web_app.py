...
FIRST_ANSWER_SECONDS = 20
NEXT_ANSWER_SECONDS = 10
...
state = {
    ...
    "current_buzz": None,
    "phase": "board",  # board, preview, question_open, answering
    "attempt_number": 0,
    "timer_end": None,
    "timer_duration": 0,
    "last_message": ""
...
def public_question_payload(round_index, category_index, question_index):
    ...
    return {
        ...
        "host_note": question.get("host_note", "")
    }
...
def answer_time_for_current_attempt():
    if state["attempt_number"] <= 1:
        return FIRST_ANSWER_SECONDS

    return NEXT_ANSWER_SECONDS
...
def status():
    return jsonify({
        ...
        "settings": {
            ...
            "next_answer_seconds": NEXT_ANSWER_SECONDS
        }
    })
...
def buzz():
    ...
    seconds = answer_time_for_current_attempt()
    start_timer(seconds)
